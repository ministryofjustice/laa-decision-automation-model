 ...
 *         &lt;element name="PreferredAddress" type="{http://legalservices.gov.uk/Enterprise/Common/1.0/Common}C50"/&gt;
 *         &lt;element name="CorrespondenceAddress" type="{http://legalservices.gov.uk/Enterprise/Common/1.0/Common}Address" minOccurs="0"/&gt;
 *         &lt;element name="ProviderDetails" type="{http://legalservices.gov.uk/CCMS/CaseManagement/Case/1.0/CaseBIO}ProviderDetails"/&gt;
 ...
 *         &lt;element name="PurposeOfApplication" type="{http://legalservices.gov.uk/Enterprise/Common/1.0/Common}C2000"/&gt;
...
public class ApplicationDetails {
    ...
    @XmlElement(name = "PreferredAddress", required = true)
    ...
    @XmlElement(name = "PurposeOfApplication", required = true)
